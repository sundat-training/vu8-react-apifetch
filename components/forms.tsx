...
export function FormItemReadonly({ value, attr, label }: { value: string | undefined; attr: string; label: string; }) {
    return <div
...
export function FormItem({ value, attr, label, onChange }: FormItemProps) {
    return <div
        className="relative z-0 w-full mb-5 group"
    >
        <input type="text" name={attr} id={attr}
